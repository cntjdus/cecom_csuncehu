...
const DEFAULT_MISSIONS = [
  "세콤네컷 프레임으로 사진 찍고 인스타 스토리에 업로드하기", "각자 공부하는 패드 사진 찍어서 합쳐서 업로드", "밤에 학교 주변 짧게 한바퀴 산책하기", "같은 배경으로 각각 사진 찍어서 합치기", "코노 가서 90점 이상 맞기(2명 이상)",
  "직접 수기로 롤링페이퍼 써주기", "대동제 푸드트럭에서 음식 사 먹기", "모각할 참여하기(전원 동시 참여)", "축제 프레임으로 인생네컷 찍기(ex.총장네컷)", "서로 과제 하나 도와주기",
  "대동제 부스 적어도 1개 같이 참여하기", "시험 끝나고 할 약속 하나 잡기", "같이 학교 야경을 배경으로 단체 사진 찍기", "같이 와플파파 가서 와플 먹기", "같이 편의점 가서 편밥하기",
  "축제 공연에서 찍은 사진 인스타 스토리 업로드하기(4명이상)", "단체 셀카 각각 다른 날로 2회이상 찍기", "같은 색 옷이나 아이템 맞추기", "같이 셋로그 영상 찍기(인정 기준:시간대별로 3번 이상 전원 업로드", "시험기간에 서로에게 응원 카톡 보내기",
  "중앙사랑 인스타에서 추천된 장소(ex. 카페, 맛집) 하나 가보기", "시험기간에 다같이 도서관 가기", "빼광에서 배달음식 시켜먹기 *디저트류 제외", "동방에서 디저트류 시켜먹기 *배민, 쿠팡이츠로 인증", "축제 때 다른 조와 만나서 같이 사진 찍기(합 최소 4~6명)"
];
