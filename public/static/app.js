...
const DEFAULT_MISSIONS = [
  "동작구 외 다른 지역에서 만나기", "중냥이랑 사진 찍기", "흑석 맛집 1곳 이상 가보기", "인생네컷 찍기", "다른 조와 만나서 놀기",
  "포탈 이용해보기", "한강 가서 라면 먹기", "같이 학식 먹기", "같이 동방 / 보겜카에서 보드게임하기", "인스타 맞팔하기",
  "같이 카페가기", "에타 친구 맺기", "릴스 찍고 CECOM 인스타 태그해서 올리기", "코노 가기", "다같이 세트룸 오기",
  "플리 공유하기", "같이 술 마시기", "캠퍼스 산책하기", "다같이 한강 런닝하기", "서로를 태그한 인스타 스토리 업로드하기",
  "세콤네컷 프레임으로 사진 찍고 인스타 스토리에 업로드하기", "세콤 동방 와서 거울샷 찍기", "같이 항공샷(다른 MZ샷) 찍기", "연락처 공유하기", "상도 맛집 1곳 이상 가보기"
];
